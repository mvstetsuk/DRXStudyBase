  ...
  public class ModuleFunctions
  {
    ...
    public virtual string GetPowersBase(Docflow.ISignatureSetting signatureSetting)
    {
      if (signatureSetting == null)
        return string.Empty;
      var powersBase = signatureSetting.Reason == Docflow.SignatureSetting.Reason.Duties
      ...
      powersBase = PublicFunctions.Module.CutText(powersBase, Constants.AccountingDocumentBase.PowersBaseMaxLength);
      return powersBase;
    }
  }
}